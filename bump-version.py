#!/usr/bin/env python3
# Increments the patch component of VERSION in JasmineKICQ.pro. build-symbian.cmd runs this
# before each phone build, so JasmineKICQ.pro always names the newest package and every build
...
import re, sys, os
pro = os.path.join(os.path.dirname(os.path.abspath(__file__)), "JasmineKICQ.pro")
